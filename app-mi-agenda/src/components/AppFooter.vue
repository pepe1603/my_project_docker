<template>
  <div class="footer-container">
      <h2>MyNotebook Address - Gestiona tus contactos de manera eficiente</h2>
      <p class="footer-text">Desarrollado por Estudiantes de LIDTS de la UNACH CAMPUS IV.</p>
  ...
  <p class="copyright">© {{ currentYear }} 2024 - MyNotebook Address. Todos los derechos reservados.</p>
...
export default {
  ...
  name: 'appFooter',
  //crear metodo para obtener la fecha libreria Timejs
